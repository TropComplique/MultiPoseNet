...
from code.constants import EPSILON, SCALE_FACTORS
...
def batch_decode(box_encodings, anchors):
    ...
    """
    batch_size = box_encodings.shape[0].value  # a static value
    num_anchors = tf.shape(box_encodings)[1]  # a dynamic value
